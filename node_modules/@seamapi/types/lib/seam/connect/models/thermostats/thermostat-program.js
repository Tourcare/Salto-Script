...
export const thermostat_daily_program_period = z
    ...
    starts_at_time: z
        ...
        .describe('Time at which the thermostat daily program period starts, in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format.'),
    climate_preset_key: z
        .string()
        .describe('Key of the [climate preset](https://docs.seam.co/latest/capability-guides/thermostats/creating-and-managing-climate-presets) to activate at the `starts_at_time`.'),
})
    .describe('Period for a thermostat daily program. Consists of a starts at time and the key that identifies the configured climate preset to apply at the starting time.');
export const thermostat_daily_program = z.object({
    ...
    device_id: z
        .string()
        .uuid()
        .describe('ID of the thermostat device on which the thermostat daily program is configured.'),
    name: z
        .string()
        .nullable()
