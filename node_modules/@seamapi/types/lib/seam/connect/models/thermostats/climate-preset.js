...
export const climate_preset = z.object({
    climate_preset_key: z
        .string()
        .describe('Unique key to identify the [climate preset](https://docs.seam.co/latest/capability-guides/thermostats/creating-and-managing-climate-presets).'),
    can_edit: z
        .boolean()
        .describe('Indicates whether the [climate preset](https://docs.seam.co/latest/capability-guides/thermostats/creating-and-managing-climate-presets) key can be edited.'),
    can_delete: z
        .boolean()
    ...
    name: z
        ...
        .default(null)
        .optional()
        .describe('User-friendly name to identify the [climate preset](https://docs.seam.co/latest/capability-guides/thermostats/creating-and-managing-climate-presets).'),
    display_name: z
        .string()
  ...
  `),
    ...
    heating_set_point_celsius: z
        .number()
        .optional()
        .describe('Temperature to which the thermostat should heat (in °C). See also [Set Points](https://docs.seam.co/latest/capability-guides/thermostats/understanding-thermostat-concepts/set-points).'),
    cooling_set_point_fahrenheit: z
        .number()
        .optional()
        .describe('Temperature to which the thermostat should cool (in °F). See also [Set Points](https://docs.seam.co/latest/capability-guides/thermostats/understanding-thermostat-concepts/set-points).'),
    heating_set_point_fahrenheit: z
        .number()
        .optional()
        .describe('Temperature to which the thermostat should heat (in °F). See also [Set Points](https://docs.seam.co/latest/capability-guides/thermostats/understanding-thermostat-concepts/set-points).'),
