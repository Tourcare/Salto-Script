...
export const thermostat_schedule = z.object({
    ...
    is_override_allowed: z
        .boolean()
        .optional()
        .describe("Indicates whether a person at the thermostat can change the thermostat's settings after the [thermostat schedule](https://docs.seam.co/latest/capability-guides/thermostats/creating-and-managing-thermostat-schedules) starts."),
    ends_at: z
        .string()
        .datetime()
