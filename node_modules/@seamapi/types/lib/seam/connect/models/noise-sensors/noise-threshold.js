...
export const noise_threshold = z.object({
    ...
    device_id: z
        .string()
        .uuid()
        .describe('Unique identifier for the device that contains the noise threshold.'),
    name: z.string().describe('Name of the noise threshold.'),
    noise_threshold_nrs: z
        .number()
        .optional()
        .describe('Noise level in Noiseaware Noise Risk Score (NRS) for the noise threshold. This parameter is only relevant for [Noiseaware sensors](https://docs.seam.co/latest/device-and-system-integration-guides/noiseaware-sensors).'),
    starts_daily_at: z
        .string()
        .describe('Time at which the noise threshold should become active daily.'), // TODO: zoned_time
    ends_daily_at: z
        .string()
        .describe('Time at which the noise threshold should become inactive daily.'), // TODO: zoned_time
...
`);
//# sourceMappingURL=noise-threshold.js.map