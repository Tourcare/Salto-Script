...
export const device_metadata = z
    ...
    brivo_metadata: z
        ...
        activation_enabled: z
            .boolean()
            .describe(`Indicates whether the Brivo access point has activation (remote unlock) enabled.`),
    })
        .partial()
    ...
    igloohome_metadata: z
        ...
        is_keypad_linked_to_bridge: z
            .boolean()
            .optional()
            .describe(`Indicates whether a keypad is linked to a bridge for an igloohome device.`),
    })
    ...
    nest_metadata: z
        ...
        device_name: z
            .string()
            .describe(`Device name for a Google Nest device. Google sets this value.`), // set by Google
        device_custom_name: z
            .string()
            .describe(`Custom device name for a Google Nest device. The device owner sets this value.`), // set by device owner
        display_name: z
            .string()
            .optional()
