...
export declare const LOCK_DEVICE_TYPE: {
    ...
    readonly AKILES_LOCK: "akiles_lock";
};
...
/** Keys */
export declare const KEY_DEVICE_TYPE: {
    readonly KEYNEST_KEY: "keynest_key";
};
export declare const KEY_DEVICE_TYPE_LIST: "keynest_key"[];
export declare const key_device_type: z.ZodEnum<["keynest_key"]>;
...
export declare const THERMOSTAT_DEVICE_TYPE: {
    ...
    readonly TADO_THERMOSTAT: "tado_thermostat";
    readonly SENSI_THERMOSTAT: "sensi_thermostat";
    readonly SMARTTHINGS_THERMOSTAT: "smartthings_thermostat";
};
...
export declare const any_device_type: z.ZodUnion<[z.ZodEnum<[LockDeviceTypeFromMapping]>, z.ZodEnum<["keynest_key"]>, z.ZodEnum<[NoiseSensorDeviceTypeFromMapping]>, z.ZodEnum<[ThermostatDeviceTypeFromMapping]>, z.ZodEnum<[PhoneDeviceTypeFromMapping]>]>;
