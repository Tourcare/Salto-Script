...
export const lock_device_type = z.enum(Object.values(LOCK_DEVICE_TYPE)).describe(`Device type for smartlocks.
          `);
/** Keys */
...
export const key_device_type = z.enum(Object.values(KEY_DEVICE_TYPE)).describe(`Device type for keys.
          `);
/** Noise Sensors */
...
export const noise_sensor_device_type = z.enum(Object.values(NOISE_SENSOR_DEVICE_TYPE)).describe(`Device type for noise sensors.
          `);
/** Thermostats */
...
export const thermostat_device_type = z.enum(Object.values(THERMOSTAT_DEVICE_TYPE)).describe(`Device type for thermostats.
          `);
/** Phones */
...
export const phone_device_type = z.enum(Object.values(PHONE_DEVICE_TYPE_LIST)).describe(`Device type for phones.
          `);
