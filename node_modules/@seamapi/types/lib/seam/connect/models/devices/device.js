...
const account_disconnected = common_device_error
    ...
    is_connected_account_error: z
        .literal(true)
        .describe('Indicates that the error is a [connected account](https://docs.seam.co/latest/api/connected_accounts) error.'),
    is_device_error: z
        .literal(false)
...
const functional_offline_device = common_device_warning
    ...
    .describe('Indicates that the device is offline but has some functionality available.');
...
const lockly_time_zone_not_configured = common_device_warning
    ...
    .describe('Indicates that Seam detected that the Lockly device does not have a time zone configured. Time-bound codes may not work as expected.');
...
export const device_and_connected_account_error_options = [
    ...
    ...connected_account_error.options.filter((_connected_account_error) => !device_error.options.some((_device_error) => _device_error.shape.error_code.value ===
...
export const device = z
  ...
  `),
    ...
    is_managed: z
        .literal(true)
        .describe('Indicates whether Seam manages the device. See also [Managed and Unmanaged Devices](https://docs.seam.co/latest/core-concepts/devices/managed-and-unmanaged-devices).'),
    custom_metadata,
})
