...
export const instant_key = z.object({
    ...
    workspace_id: z
        .string()
        .uuid()
        .describe('ID of the [workspace](https://docs.seam.co/latest/core-concepts/workspaces) that contains the Instant Key.'),
    created_at: z
        .string()
        .datetime()
    ...
    instant_key_url: z
        .string()
        .url()
        .describe('Shareable URL for the Instant Key. Use the URL to deliver the Instant Key to your user through a link in a text message or email or by embedding it in your web app.'),
    client_session_id: z
        .string()
        .uuid()
        .describe('ID of the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens) associated with the Instant Key.'),
    user_identity_id: z
        .string()
        .uuid()
