...
const common_connected_account_error = z.object({
    ...
    is_connected_account_error: z
        .boolean()
        .optional()
        .describe('Indicates whether the error is related specifically to the connected account.'),
    is_bridge_error: z
        .boolean()
        .optional()
        .describe('Indicates whether the error is related to [Seam Bridge](https://docs.seam.co/latest/capability-guides/seam-bridge).'),
});
...
export const salto_ks_subscription_limit_exceeded = common_connected_account_error
    ...
    salto_ks_metadata: z
        ...
        sites: z
            ...
            site_id: z
                .string()
                .describe('ID of a Salto site associated with the connected account that has an error.'),
            site_name: z
                .string()
                .describe('Name of a Salto site associated with the connected account that has an error.'),
            subscribed_site_user_count: z
                .number()
                .int()
                .min(0)
                .describe('Count of subscribed site users for a Salto site associated with the connected account that has an error.'),
            site_user_subscription_limit: z
                .number()
                .int()
                .min(0)
                .describe('Subscription limit of site users for a Salto site associated with the connected account that has an error.'),
        })
            .describe('Salto site associated with the connected account that has an error.'))
            .describe('Salto sites associated with the connected account that has an error.'),
    })
...
export const unknown_issue_with_connected_account = common_connected_account_warning
    ...
    .describe('Indicates that an unknown issue occurred while syncing the state of the connected account with the provider. This issue may affect the proper functioning of one or more resources in the account.');
const scheduled_maintenance_window = common_connected_account_warning
    ...
    .describe('Indicates that scheduled downtime is planned for the connected account.');
const salto_ks_subscription_limit_almost_reached = common_connected_account_warning
    ...
    salto_ks_metadata: z
        ...
        sites: z
            ...
            site_id: z
                .string()
                .describe('ID of a Salto site associated with the connected account that has a warning.'),
            site_name: z
                .string()
                .describe('Name of a Salto site associated with the connected account that has a warning.'),
            site_user_subscription_limit: z
                .number()
                .int()
                .min(0)
                .describe('Subscription limit of site users for a Salto site associated with the connected account that has a warning.'),
            subscribed_site_user_count: z
                .number()
                .int()
                .min(0)
                .describe('Count of subscribed site users for a Salto site associated with the connected account that has a warning.'),
        })
            .describe('Salto site associated with the connected account that has a warning.'))
            .describe('Salto sites associated with the connected account that has a warning.'),
    })
...
export const connected_account = z.object({
    ...
    user_identifier: z
        ...
        username: z
            .string()
            .optional()
            .describe('Username of the user identifier associated with the connected account.'),
        api_url: z
            .string()
            .optional()
            .describe('API URL for the user identifier associated with the connected account.'),
        email: z
            .string()
            .optional()
            .describe('Email address of the user identifier associated with the connected account.'),
        phone: z
            .string()
            .optional()
            .describe('Phone number of the user identifier associated with the connected account.'),
        exclusive: z
            .boolean()
            .optional()
            .describe('Indicates whether the user identifier associated with the connected account is exclusive.'),
    })
        .optional()
    ...
    automatically_manage_new_devices: z
        .boolean()
        .describe('Indicates whether Seam should [import all new devices](https://docs.seam.co/latest/core-concepts/connect-webviews/customizing-connect-webviews#automatically_manage_new_devices) for the connected account to make these devices available for management by the Seam API.'),
    customer_key: z
        .string()
        .optional()
