...
export const bridge_lan_unreachable = common_bridge_client_session_error
    ...
    is_tailscale_proxy_socks_server_healthy: z
        .boolean()
        .nullable()
        .describe("Indicates whether the Tailscale proxy's SOCKS server is healthy."),
    can_tailscale_proxy_reach_tailscale_network: z
        .boolean()
        .nullable()
        .describe('Indicates whether the Tailscale proxy can reach the Tailscale network.'),
...
export const bridge_client_session_error = z
    ...
    .describe('Indicates an error associated with the Seam Bridge client session.');
...
export const bridge_client_session = z.object({
    created_at: z
        .string()
        .datetime()
        .describe('Date and time at which the Seam Bridge client session was created.'),
    ...
    bridge_client_session_token: z
        .string()
        .describe('Client session token associated with the Seam Bridge client session.'),
    pairing_code: z
        .string()
        .length(6)
        .describe('Pairing code for Seam Bridge. Use this code to pair Seam Bridge with your workspace.'),
    ...
    bridge_client_machine_identifier_key: z
        .string()
        .describe('Identifier key of the client machine for the Seam Bridge client.'),
    errors: z
    ...
    telemetry_token_expires_at: z
        ...
        .datetime()
        .nullable()
        .describe('Date and time at which the telemetry token for the Seam Bridge client session expires.'),
    telemetry_url: z
        .string()
        .nullable()
