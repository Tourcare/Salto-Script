...
export const client_session = z.object({
    client_session_id: z
        .string()
        .uuid()
        .describe('ID of the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens).'),
    workspace_id: z
        .string()
        .uuid()
        .describe('ID of the [workspace](https://docs.seam.co/latest/core-concepts/workspaces) associated with the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens).'),
    created_at: z
        .string()
        .datetime()
        .describe('Date and time at which the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens) was created.'),
    expires_at: z
        .string()
        .datetime()
        .describe('Date and time at which the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens) expires.'),
    token: z
        .string()
        .describe('Client session token associated with the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens).'),
    user_identifier_key: z
        .string()
        .nullable()
        .describe('Your user ID for the user associated with the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens).'),
    device_count: z
        .number()
    ...
    connect_webview_ids: z
        .array(z.string().uuid())
        .describe('IDs of the [Connect Webviews](https://docs.seam.co/latest/core-concepts/connect-webviews) associated with the [client session](https://docs.seam.co/latest/core-concepts/authentication/client-session-tokens).'),
  ...
  `),
    user_identity_id: z
        ...
        .uuid()
        .optional()
        .describe('ID of the [user identity](https://docs.seam.co/latest/capability-guides/mobile-access/managing-mobile-app-user-accounts-with-user-identities#what-is-a-user-identity) associated with the client session.'),
}).describe(`
  ---
