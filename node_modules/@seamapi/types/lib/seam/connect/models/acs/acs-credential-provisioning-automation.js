...
export const enrollment_automation = z.object({
    ...
    user_identity_id: z
        .string()
        .uuid()
        .describe('ID of the associated [user identity](https://docs.seam.co/latest/capability-guides/mobile-access/managing-mobile-app-user-accounts-with-user-identities#what-is-a-user-identity).'),
    created_at: z
        .string()
        .datetime()
