...
export const acs_entrance_assa_abloy_vostio_metadata = z
    ...
    stand_open: z
        .boolean()
        .optional()
        .describe('Indicates whether keys are allowed to set the door in stand open mode in the Vostio access system.'),
    pms_id: z
        .string()
        .optional()
...
export const acs_credential_vostio_metadata = z
    ...
    auto_join: z
        .boolean()
        .optional()
        .describe('Indicates whether the credential should auto-join. For an auto-join credential, Seam automatically issues an override card if there are no other cards and a joiner card if there are existing cards on the doors.'),
    override_guest_acs_entrance_ids: z
        .string()
        .array()
        .optional()
        .describe('IDs of the guest entrances to override in the Vostio access system.'),
    key_id: z
        .string()
        .optional()
    ...
    door_names: z
        ...
        .array()
        .optional()
        .describe('Names of the doors to which to grant access in the Vostio access system.'),
    endpoint_id: z
        .string()
        .optional()
        .describe('Endpoint ID in the Vostio access system.'),
})
    .describe('ASSA ABLOY Vostio-specific metadata associated with the credential.');
