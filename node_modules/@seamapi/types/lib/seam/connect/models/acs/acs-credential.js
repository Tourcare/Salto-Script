import { z } from 'zod';
import { acs_credential_visionline_metadata, acs_credential_vostio_metadata, } from './metadata/index.js';
...
export const unknown_issue_with_acs_credential = common_acs_credential_warning
    ...
    .describe('An unknown issue occurred while syncing the state of the [credential](https://docs.seam.co/latest/capability-guides/access-systems/managing-credentials) with the provider. This issue may affect the proper functioning of the credential.');
...
const common_acs_credential = z.object({
    ...
    connected_account_id: z
        .string()
        .uuid()
        .describe('ID of the [connected account](https://docs.seam.co/latest/capability-guides/access-systems/managing-credentials#connected-accounts) to which the [credential](https://docs.seam.co/latest/capability-guides/access-systems/managing-credentials) belongs.'),
...
export const acs_credential_on_encoder = z.object({
    ...
    visionline_metadata: z
        ...
        card_holder: z
            .string()
            .optional()
            .describe('Holder of the card associated with the [credential](https://docs.seam.co/latest/capability-guides/access-systems/managing-credentials).'),
