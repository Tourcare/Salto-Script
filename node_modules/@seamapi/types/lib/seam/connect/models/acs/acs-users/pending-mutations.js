...
const creating = common_pending_mutation
    ...
    mutation_code: z
        .literal('creating')
        .describe('Mutation code to indicate that Seam is in the process of pushing a user creation to the integrated access system.'),
})
    .describe('Seam is in the process of pushing a user creation to the integrated access system.');
...
export const updating_user_information_mutation = common_pending_mutation.extend({
    mutation_code: z
        ...
        .describe('Mutation code to indicate that Seam is in the process of pushing updated user information to the integrated access system.'),
    from: acs_user_info
        .partial()
...
const updating_suspension_state_mutation = common_pending_mutation
    ...
    mutation_code: z
        ...
        .describe('Mutation code to indicate that Seam is in the process of pushing updated user suspension state information to the integrated access system.'),
    from: z
    ...
    .describe('Seam is in the process of pushing a suspension state update to the integrated access system.');
const updating_group_membership_mutation = common_pending_mutation
    .extend({
    mutation_code: z
        .literal('updating_group_membership')
        .describe('Mutation code to indicate that Seam is in the process of pushing updated access group membership information to the integrated access system.'),
    from: z
        .object({
    ...
    .describe('Seam is in the process of pushing an access group membership update to the integrated access system.');
