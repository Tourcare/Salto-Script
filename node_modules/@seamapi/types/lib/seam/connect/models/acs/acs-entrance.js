...
import { acs_entrance_assa_abloy_vostio_metadata, acs_entrance_dormakaba_community_metadata, acs_entrance_hotek_metadata, acs_entrance_latch_metadata, acs_entrance_salto_ks_metadata, acs_entrance_visionline_metadata, } from './metadata/index.js';
...
export const acs_entrance_capability_flags = z.object({
    can_unlock_with_mobile_key: z
        .boolean()
        .optional()
        .describe('Indicates whether the ACS entrance can be unlocked with mobile key credentials.'),
    can_unlock_with_card: z
        .boolean()
        .optional()
        .describe('Indicates whether the ACS entrance can be unlocked with card credentials.'),
...
export const acs_entrance = z
    ...
    hotek_metadata: acs_entrance_hotek_metadata
        .optional()
        .describe('Hotek-specific metadata associated with the [entrance](https://docs.seam.co/latest/capability-guides/access-systems/retrieving-entrance-details).'),
