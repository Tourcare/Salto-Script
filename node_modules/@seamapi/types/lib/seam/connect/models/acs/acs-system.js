...
export const acs_location = z.object({
    time_zone: z
        .string()
        .nullable()
        .describe('Time zone in which the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) is located.'),
});
...
const acs_system_disconnected = common_acs_system_error
    ...
    .describe('Indicates that the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) has been disconnected. See [Troubleshooting Your Access Control System](https://docs.seam.co/latest/capability-guides/access-systems/troubleshooting-your-access-control-system) to resolve the issue.');
const account_disconnected = common_acs_system_error
    ...
    .describe('Indicates that the login credentials are invalid. Reconnect the account using a [Connect Webview](https://docs.seam.co/latest/ui-components/connect-webviews) to restore access.');
const salto_ks_certification_expired = common_acs_system_error
    ...
    .describe('Indicates that the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) has lost its Salto KS certification. Contact [support](mailto:support@seam.co) to regain access.');
...
const salto_ks_subscription_limit_almost_reached = common_acs_system_warning
    ...
    .describe('Indicates that the Salto KS site has exceeded 80% of the maximum number of allowed users. Increase your subscription limit or delete some users from your site to rectify the issue.');
const time_zone_does_not_match_location = common_acs_system_warning
    ...
    .describe('Indicates the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) time zone could not be determined because the reported physical location does not match the time zone configured on the physical [ACS entrances](https://docs.seam.co/latest/capability-guides/access-systems/retrieving-entrance-details).');
const acs_system_warning = z
    .discriminatedUnion('warning_code', [
    salto_ks_subscription_limit_almost_reached,
    time_zone_does_not_match_location,
])
    .describe('Warning associated with the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).');
...
export const acs_system = z
    ...
    default_credential_manager_acs_system_id: z
        ...
        .nullable()
        .optional()
        .describe('ID of the default credential manager `acs_system` for this [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    acs_system_id: z
        .string()
        .uuid()
        .describe('ID of the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    acs_user_count: z.number().optional(),
    acs_access_group_count: z.number().optional(),
    external_type: acs_system_external_type
        .describe('Brand-specific terminology for the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) type.')
        .optional(),
    external_type_display_name: z
        .string()
        .describe('Display name that corresponds to the brand-specific terminology for the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) type.')
        .optional(),
    ...
    visionline_metadata: z
        ...
        lan_address: z
            .string()
            .describe('IP address or hostname of the main Visionline server relative to [Seam Bridge](https://docs.seam.co/latest/capability-guides/seam-bridge) on the local network.'),
    })
        .optional(),
    ...
    name: z
        .string()
        .describe('Name of the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    created_at: z
        .string()
        .datetime()
        .describe('Date and time at which the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) was created.'),
    workspace_id: z
        .string()
        .uuid()
        .describe('ID of the [workspace](https://docs.seam.co/latest/core-concepts/workspaces) that contains the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    ...
    connected_account_id: z
        .string()
        .uuid()
        .describe('ID of the [connected account](https://docs.seam.co/latest/core-concepts/connected-accounts) associated with the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    image_url: z
        .string()
        .describe('URL for the image that represents the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    image_alt_text: z
        .string()
        .describe('Alternative text for the [access control system](https://docs.seam.co/latest/capability-guides/access-systems) image.'),
    errors: z
        .array(acs_system_error)
        .describe('Errors associated with the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
    warnings: z
        .array(acs_system_warning)
        .describe('Warnings associated with the [access control system](https://docs.seam.co/latest/capability-guides/access-systems).'),
})
