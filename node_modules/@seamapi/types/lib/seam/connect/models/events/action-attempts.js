...
export const action_attempt_lock_door_succeeded_event = action_attempt_event.extend({
  ...
  `);
export const action_attempt_lock_door_failed_event = action_attempt_event.extend({
  ...
  `);
export const action_attempt_unlock_door_succeeded_event = action_attempt_event.extend({
  ...
  `);
export const action_attempt_unlock_door_failed_event = action_attempt_event.extend({
