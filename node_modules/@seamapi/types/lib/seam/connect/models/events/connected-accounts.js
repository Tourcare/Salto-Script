...
export const connected_account_disconnected_event = connected_account_event.extend({
  ...
  `);
export const connected_account_completed_first_sync_event = connected_account_event.extend({
...
`);
export const connected_account_completed_first_sync_after_reconnection_event = connected_account_event.extend({
