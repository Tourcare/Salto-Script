...
const smartthings_failed_to_set_after_multiple_retries = common_access_code_error
    .extend({
    error_code: z
...
const kwikset_unable_to_confirm_deletion = common_access_code_error
    ...
    .describe('Unable to confirm the deletion of the access code on Kwikset device.');
const kwikset_insufficient_permissions = common_access_code_error
    ...
    .describe('Admin role required—insufficient permissions to manage PINs on this Kwikset device. Please have a Home Admin update your role in the Kwikset app, or ask them to set the PIN.');
const igloohome_offline_access_code_no_variance_available = common_access_code_error
    .extend({
    error_code: z
...
const third_party_integration_detected = common_access_code_warning
    ...
    .describe('Third-party integration detected that may cause access codes to fail.');
...
export const access_code = z.object({
    workspace_id: z
        .string()
        .uuid()
        .describe('Unique identifier for the Seam workspace associated with the access code.'),
    common_code_key: z
        .string()
        .nullable()
    ...
    type: z
        ...
        .describe('Type of the access code. `ongoing` access codes are active continuously until deactivated manually. `time_bound` access codes have a specific duration.'),
    ...
    errors: z.array(z.discriminatedUnion('error_code', [
