...
const result = z
    ...
    acs_credential_on_seam: acs_credential_on_seam
        .nullable()
        .describe('Corresponding credential data as stored on Seam and the access system.'),
    warnings: z
        .array(warning)
        .describe('Warnings related to scanning the credential, such as mismatches between the credential data currently encoded on the card and the corresponding data stored on Seam and the access system.'),
})
    .describe('Result of scanning a card. If the attempt was successful, includes a snapshot of credential data read from the physical encoder, the corresponding data stored on Seam and the access system, and any associated warnings.');
...
//# sourceMappingURL=scan-credential.js.map